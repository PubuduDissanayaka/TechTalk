...
$('.friend').click(function (e) {
  ...
  var data = {
    friend_id: friendid // console.log(friendid);

  };
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/friends', data).then(function (response) {
    // console.log(e);
...
$('.remove').click(function (e) {
  ...
  var friendid = e.target.dataset['friendid']; // console.log(friendid);
  // console.log(e);

  var data = {
    friend_id: friendid
  };
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/friends/remove', data).then(function (response) {
    // console.log(e);
...
$('.request').click(function (e) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/request', data).then(function (response) {
    // console.log(e);
...
module.exports = __webpack_require__(/*! C:\Users\TECHTALK\Documents\Moratuwa\TechTalk\resources\js\main.js */"./resources/js/main.js");
